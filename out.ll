...
entry:
  ...
  %1 = lshr i32 %0, 1
  store i32 %1, ptr %result_type_OK1, align 4
  %2 = load i32, ptr %lhs1, align 4
  %div1 = udiv i32 %2, -2
  store i32 %div1, ptr %UB1, align 4
  store i32 512, ptr %lhs2, align 4
  %3 = load i32, ptr %lhs2, align 4
  %4 = lshr i32 %3, 3
  store i32 %4, ptr %result_type_OK2, align 4
  store i32 256, ptr %lhs3, align 4
  %5 = load i32, ptr %lhs3, align 4
  %6 = ashr i32 %5, 6
  store i32 %6, ptr %result_type_OK3, align 4
  %7 = load i32, ptr %lhs3, align 4
  %div4 = sdiv i32 %7, -64
  store i32 %div4, ptr %Not_UB1, align 4
  %8 = load i32, ptr %lhs3, align 4
  %sub = sub nsw i32 0, %8
  %9 = ashr i32 %sub, 6
  store i32 %9, ptr %result_type_OK4, align 4
  %10 = load i32, ptr %lhs3, align 4
  %sub6 = sub nsw i32 0, %10
  %div7 = sdiv i32 %sub6, -64
  store i32 %div7, ptr %Not_UB2, align 4
  store i32 128, ptr %lhs4, align 4
  %11 = load i32, ptr %lhs4, align 4
  %12 = lshr i32 %11, 5
  store i32 %12, ptr %result_type_OK5, align 4
  %13 = load i32, ptr %lhs4, align 4
  %sub9 = sub nsw i32 0, %13
  %14 = lshr i32 %sub9, 5
  store i32 %14, ptr %UB2, align 4
  store i32 128, ptr %lhs5, align 4
  %15 = load i32, ptr %lhs5, align 4
  %div11 = udiv i32 %15, 3
  store i32 %div11, ptr %result_type_OK7, align 4
  %16 = load i32, ptr %lhs5, align 4
  %sub12 = sub nsw i32 0, %16
  %div13 = udiv i32 %sub12, 3
  store i32 %div13, ptr %UB3, align 4
  store i32 126, ptr %lhs6, align 4
  %17 = load i32, ptr %lhs6, align 4
  %18 = ashr i32 %17, 2
  store i32 %18, ptr %result_type_OK9, align 4
  %19 = load i32, ptr %lhs6, align 4
  %sub15 = sub nsw i32 0, %19
  %20 = ashr i32 %sub15, 2
  store i32 %20, ptr %UB4, align 4
  store double 0x408BF770A3D70A3D, ptr %lhs7, align 8
  %21 = load double, ptr %lhs7, align 8
  %div17 = fdiv double %21, 4.000000e+00
  store double %div17, ptr %result_type_OK11, align 8
  %22 = load double, ptr %lhs7, align 8
  %div18 = fdiv double %22, -4.000000e+00
  store double %div18, ptr %result_type_OK12, align 8
  store i32 6, ptr %lhs8, align 4
  %23 = load i32, ptr %lhs8, align 4
  ...
  %25 = load i64, ptr %lhs9, align 8
  %26 = ashr i64 %25, 5
  store i64 %26, ptr %result_type_OK15, align 8
  %27 = load i64, ptr %lhs9, align 8
  %div25 = sdiv i64 %27, -32
